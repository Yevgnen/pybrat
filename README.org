...
Below is an [[/Users/Maximin/git/pybrat/examples/example.py][example]] of parsing [[https://github.com/nlplab/brat/tree/master/example-data/corpora/BioNLP-ST_2011][BioNLP-ST_2011]] data:
